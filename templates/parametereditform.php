<script type='text/javascript'>
  $(function(){
    $( '#configform' ).submit(function(event){
      ...
      $.ajax({
        url: '/parameteredit.php',
        method: 'POST',
        data: data,
        success: function(response) {
          document.location.href='/parameterview.php';
        },
        error: function() {
  ...
  <fieldset>
    ...
    <div class="form-group">
      ...
      <div class="col-md-8">
        ...
        <button id="cancel" name="cancel" class="btn btn-default" onClick="document.location.href='/parameterview.php';">Cancel</button>
      </div>
    </div>
